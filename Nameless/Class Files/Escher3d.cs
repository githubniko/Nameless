...
{
    // код с# взять из проекта https://github.com/spiffcow/DeltaCalibration
    ...
    class Escher3d
    {
        ...
        public Escher3d(double diagonal, double radius, double height, double xstop, double ystop, double zstop, double xadj, double yadj, double zadj)
        {
        ...
        {
            var perturb = 0.2d;          // perturbation amount in mm or degrees
            var hiParams = new Escher3d(this.diagonal, this.radius, this.homedHeight, this.xstop, this.ystop, this.zstop, this.xadj, this.yadj, this.zadj);
            var loParams = new Escher3d(this.diagonal, this.radius, this.homedHeight, this.xstop, this.ystop, this.zstop, this.xadj, this.yadj, this.zadj);
            switch (deriv)
            {
                case 0:
                case 1:
